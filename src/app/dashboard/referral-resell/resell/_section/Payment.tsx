...
const Payment = () => {
  ...
  return (
    <Stack spacing={6} width={'100%'}>
      ...
      <Stack spacing={6}>
        <Typography sx={{ color: 'white', ...getFontValue(22, 500), pr: 5 }}>Account Count</Typography>
        <TextField name="amount" />
      </Stack>
      <Stack spacing={6}>
        <Typography sx={{ color: 'white', ...getFontValue(22, 500), pr: 5 }}>Plan</Typography>
        <RHFSelect name="plan" sx={{ minHeight: 56, borderRadius: 50 }} />
      </Stack>
